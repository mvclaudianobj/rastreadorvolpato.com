    ...
    <div id="menu-superior" class="hidden-xs hidden-sm text-right">
        <div class="container">
            <ul style="float: right;margin-bottom: 0">
                ...
                <li class="separador"></li>
                <li><a href="<?= base_url('contato'); ?>" title="Fale Conosco"><strong>CONTATO</strong></a></li>
                <li class="separador"></li>
                <li><a   target="blanck"  href="https://grupo-volpato.infojobs.com.br/MicrositeV2/List.aspx?ps=20&pn=1&imic=6842&ic=115843" title="Trabalhe Conosco"><strong>TRABALHE CONOSCO</strong></a></li>
    ...
    <section id="header-mobile" class="visible-xs visible-sm">
        ...
        <nav class="hidden-md nav-mobile collapse" id="menu-xs" aria-expanded="false" style="height: 0px;">					
            <ul class="nav">
                ...
                <li class="list-item"><a href="<?=base_url("contato"); ?>" title="Fale Conosco">CONTATO</a></li>
                <li class="list-item"><a href="https://grupo-volpato.infojobs.com.br"  target="blanck" title="Trabalhe Conosco">TRABALHE CONOSCO</a></li>
            </ul>					
        </nav>
    </section>